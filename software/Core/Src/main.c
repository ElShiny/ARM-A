...
//  pca9685_read_u8(&pca1, 0x0, &data);
//  int datalen = sprintf(msg, "data: 0x%x\r\n", data);
//  HAL_UART_Transmit(&huart3, msg, datalen, 1);
//
//  pca9685_write_u8(&pca1, 0x0, 0x11);
//  HAL_Delay(50);
//
//
//  pca9685_read_u8(&pca1, 0x0, &data);
//  datalen = sprintf(msg, "data: 0x%x\r\n", data);
//  HAL_UART_Transmit(&huart3, msg, datalen, 1);
//
//
//  HAL_UART_Transmit(&huart3, "end\r\n", sizeof("end\r\n"), 50);
